...
def train(cfg, output_dir='', run_name=''):
    ...
    for iteration in range(start_iteration, max_iteration):
        ...
        feats_fus_s = model_fusion(feats_2d_s.detach(), feats_3d_s.detach(), data_batch_src['img_indices'])
        ...
        feats_fus_t = model_fusion(feats_2d_t.detach(), feats_3d_t.detach(), data_batch_trg['img_indices'])
