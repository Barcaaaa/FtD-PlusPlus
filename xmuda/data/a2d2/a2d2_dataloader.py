...
class A2D2SCN(A2D2Base):
    def __init__(self,
        ...
        self.index_to_ignore = [5022, 5023, 5024, 5025, 5026, 5027, 5028, 5029, 5030,
                                5031, 5032, 5033, 5034, 5035, 5036, 5037, 5038, 5039]  # to large points
        self.filtered_index = [num for num in list(range(0, len(self.data))) if num not in self.index_to_ignore]

    def __getitem__(self, index):
        if index in self.index_to_ignore:
            index = random.choice(self.filtered_index)
...
def compute_class_weights():
    ...
    print(ignore_index_list)  # to large points
