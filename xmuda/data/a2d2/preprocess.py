...
class DummyDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        intensity = lidar_front_center['reflectance']
        ...
        data_dict['intensity'] = intensity.astype(np.float32)
...
if __name__ == '__main__':
    root_dir = '/media/wy/dataset/a2d2/camera_lidar_semantic'
    out_dir = '/media/wy/dataset/a2d2/a2d2_intensity_preprocess'
